/**
 * @file    stm32f407_bl.c
 * @brief   board ID and meta-data for the hardware interface circuit (HIC) based on STM32F407XX
 *
...
static const sector_info_t sectors_info[] = {
    {0x08000000 + KB(64), 0x10000},
 };

// stm32f407 target information
